...
RAMP_SCALE: Final[float] = 10.0        # multiplier: inertia × scale = ramp_in minutes
RAMP_MIN_MINUTES: Final[float] = 20.0  # floor — never shorter than this (1 price slot)
RAMP_MAX_MINUTES: Final[float] = 60.0  # ceiling — never longer than this (4 price slots)
