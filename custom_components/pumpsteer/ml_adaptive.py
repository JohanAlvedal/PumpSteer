# ml_adaptive.py - Machine learning data collection and analysis for PumpSteer
...
@dataclass
class SessionUpdate:
    """Single update entry within a learning session."""
...
class LearningSession:
    """Representation of a learning session for ML."""
...
class PumpSteerMLCollector:
    ...
    def end_session(
        ...
        session_summary = self._analyze_session(session_dict)
        self.current_session.summary = session_summary
        session_dict["summary"] = session_summary

        self.learning_sessions.append(session_dict)
